...
import { Zap, Shield, Rocket, ArrowRight, MessageSquare, TrendingUp, PieChart, Users, DollarSign, Clock } from 'lucide-react';
...
const ServiceIntroPage = () => {
  ...
  const features = [
    ...
    { icon: MessageSquare, title: "24/7 고객 응대", description: "AI 챗봇으로 언제 어디서나 고객과 소통합니다." },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-20">
        ...
        >
          <h1 className="text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">BiZBot이 제공하는 핵심 기능</h2>
        ...
        <motion.div style={{ y: yPosAnim }} className="mb-20">
          <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">BiZBot의 실제 효과</h2>
        ...
        <div className="text-center bg-indigo-600 text-white p-12 rounded-xl shadow-2xl">
          <h2 className="text-3xl font-bold mb-6">BiZBot과 함께 비즈니스를 혁신하세요</h2>
          <p className="text-xl mb-8">AI의 힘으로 당신의 비즈니스를 한 단계 끌어올리세요.</p>
          <motion.button 
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-white text-indigo-600 px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:bg-gray-100 transition duration-300"
          >
            지금 상담 받기
          </motion.button>
        </div>
        ...
        <div className="mt-20 text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-800">BiZBot 살펴보기</h2>
          <div className="aspect-w-16 aspect-h-9">
            <img src="/api/placeholder/1280/720" alt="BiZBot 대시보드 데모" className="rounded-xl shadow-2xl" />
          </div>
          <p className="mt-4 text-gray-600">BiZBot 대시보드 데모 영상</p>
        </div>
      </div>
    </div>
  );
