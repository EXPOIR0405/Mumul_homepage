        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-6">
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition duration-300">서비스 소개</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition duration-300">기능</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition duration-300">가격</a></li>
              <li><a href="#" className="bg-indigo-600 text-white px-4 py-2 rounded-full hover:bg-indigo-700 transition duration-300">무료 체험</a></li>
            </ul>
          </nav>
        </div>
      </header>
